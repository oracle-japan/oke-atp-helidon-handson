...
SET DEFINE OFF;
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (6,4,4,to_date('06-07-15','DD-MM-RR'),'Im putting an offer. Can you meet me at the apple store this evening?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (7,4,4,to_date('06-07-15','DD-MM-RR'),'Im putting an offer. Can you meet me at the apple store this evening?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (12,5,4,to_date('07-07-15','DD-MM-RR'),'Does this work with any bike?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (14,5,4,to_date('08-07-15','DD-MM-RR'),'Does this work with all bikes?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (15,5,12,to_date('08-07-15','DD-MM-RR'),'Hi, I just put an offer for this item. Where can I see it?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (16,8,6,to_date('08-07-15','DD-MM-RR'),'this item is no longer available');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (1,4,4,to_date('09-07-15','DD-MM-RR'),'hey we met yesterday but the phone''s screen was cracked. will you cover the replacement? if not drop the price by $100 and i''ll consider it');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (53,13,4,to_date('13-07-15','DD-MM-RR'),'Can you describe your guitar? is it electric?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (9,10,10,to_date('06-07-15','DD-MM-RR'),'when I come see it? I live in san ramon');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (10,10,10,to_date('06-07-15','DD-MM-RR'),'we need to meet somewhere nearby since I don''t have a car yet. Let me know if you can meet me in the DVHS parking lot');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (13,11,1,to_date('08-07-15','DD-MM-RR'),'Sunny just make an offer');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (21,21,1,to_date('12-07-15','DD-MM-RR'),'I am interested in this table');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (43,7,7,to_date('13-07-15','DD-MM-RR'),'Hi James, can you tell me old is this item?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (50,41,4,to_date('13-07-15','DD-MM-RR'),'HI, I am making an offer for this item. Hope it is in good condition. Offer subject to condition of item');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (62,22,21,to_date('21-07-15','DD-MM-RR'),'How much memory?');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (81,22,61,to_date('30-07-15','DD-MM-RR'),'Hey I just made an offer');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (101,61,1,to_date('04-08-15','DD-MM-RR'),'Hey Dave...nice bike. making as offer');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (8,4,1,to_date('06-07-15','DD-MM-RR'),'Hi, I am seriously interested in your iphone. Putting a full price offer!');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (11,10,2,to_date('06-07-15','DD-MM-RR'),'I love this bike. Just submitted an offer');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (22,3,7,to_date('12-07-15','DD-MM-RR'),'Just put an offer. Pls email me yourlocation');
Insert into COMMENTS (COMMENT_ID,ITEM_ID,COMMENT_BY,COMMENT_CREATE_DATE,COMMENT_TEXT) values (61,41,4,to_date('20-07-15','DD-MM-RR'),'Hey Im putting an offer for this. let me know');
...
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (12,7,4,76,to_date('09-07-15','DD-MM-RR'),null);
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (21,21,1,80,to_date('12-07-15','DD-MM-RR'),'accepted');
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (22,3,7,40,to_date('12-07-15','DD-MM-RR'),null);
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (23,3,7,40,to_date('12-07-15','DD-MM-RR'),'accepted');
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (81,22,42,1500,to_date('27-07-15','DD-MM-RR'),null);
...
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (41,41,4,255,to_date('13-07-15','DD-MM-RR'),'accepted');
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (101,22,61,1500,to_date('30-07-15','DD-MM-RR'),null);
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (121,61,1,90,to_date('04-08-15','DD-MM-RR'),'accepted');
...
Insert into OFFERS (OFFER_ID,ITEM_ID,OFFER_BY,OFFER_AMOUNT,OFFER_CREATE_DATE,OFFER_STATUS) values (61,22,4,1500,to_date('20-07-15','DD-MM-RR'),null);
